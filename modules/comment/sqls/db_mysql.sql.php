...
$tables ['1.1.0'] [] = "ALTER TABLE `{prefix}cms_page` 
ADD COLUMN `comments` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '评论数' AFTER `allow_comment`";
$tables ['1.1.1'] [] = "ALTER TABLE `{prefix}comments` 
ADD COLUMN `reply_count` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '回复数' AFTER `status`";

$tables ['1.1.1'] [] = "ALTER TABLE `{prefix}comments_msg` 
ADD COLUMN `reply_count` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '回复数' AFTER `status`";
