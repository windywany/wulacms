...
class MediaPreferenceForm extends AbstractForm {
	...
	private $thumbnail          = array('group' => '4', 'col' => '3', 'label' => '允许动态缩略图', 'widget' => 'radio', 'default' => '0', 'defaults' => "0=禁用\n1=启用");
	private $alloweds           = array('group' => '4', 'col' => '6', 'label' => '动态缩略图尺寸', 'note' => '格式: 80x60, 多个尺寸用","号分隔.');
	private $bestfill           = array('group' => '4', 'col' => '3', 'label' => '保持比例', 'widget' => 'radio', 'default' => '0', 'defaults' => "0=否\n1=是");
