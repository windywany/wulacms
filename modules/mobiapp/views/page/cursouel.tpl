<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
		<div class="pull-right margin-top-5 margin-bottom-5">
			<a  class="btn btn-default" href="#{'mobiapp/page'|app:0}{$channel}" id="rtn2ads">
		...
		<article class="col-sm-12">
			<div class="panel panel-default">				
				<div class="panel-body no-padding">
					<ul id="mobi-cursouel-status-tab" class="nav nav-tabs in">						
						<li>
				  	...
				  	<form id="mobi-cursouel-search-form" data-widget="nuiSearchForm" data-for="#page-table" class="smart-form">
				  		<fieldset>
				...
				<table 
					...
					data-auto="true"
					data-source="{'mobiapp/page/cursoueldata'|app}"
					data-sort="MCP.publish_time,d"	
					data-tfoot="true"
					data-tree="true">
					<thead>
						<tr>
							<th width="30"><input type="checkbox" class="grp"/></th>
							<th class="text-center" width="400">图片</th>
							<th>标题</th>
...
$('#mobi-cursouel-status-tab a').click(function(){ 
	if($(this).attr('rel') != undefined){
		$('#mobi-cursouel-status-tab li').removeClass('active');
		$(this).parents('li').addClass('active');
		var rel = $(this).attr('rel');
		$('#status').val(rel);
		$('#mobi-cursouel-search-form').submit();
	}
	return false;
});
</script>