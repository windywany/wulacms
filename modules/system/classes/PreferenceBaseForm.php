...
class PreferenceBaseForm {
	...
	public static function init($form) {
		...
		$form ['site_name'] = array ('group' => '2','col' => '3','label' => '网站名称','rules' => array ('required' => '请填写网站名称。' ) );
		$form ['site_url'] = array ('group' => '2','col' => '6','label' => '网站URL','note' => '不填写则使用系统自动检测到的URL.','rules' => array ('url' => '请填写正确的URL。' ) );
		$form ['theme'] = array ('group' => '2','col' => '3','label' => '模板主题','widget' => 'select','defaults' => implode ( "\n", $themes ),'default' => 'default' );
		$form ['site_beian'] = array ('group' => '1_5','col' => '3','label' => '网站备案号' );
		...
		$form ['site_title'] = array ('group' => '3','col' => '6','label' => '网站首页标题' );
		$form ['site_copyright'] = array ('group' => '3','col' => '6','label' => '版权信息' );
		...
		$form ['debug_level'] = array ('group' => '5_1','col' => '3','label' => '调试级别','widget' => 'select','default' => '4','defaults' => "2=调试\n3=警告\n4=信息\n5=错误\n6=关闭" );
		$form ['timezone'] = array ('group' => '5_1','col' => '3','label' => '时区','widget' => 'select','default' => 'Etc/GMT-8','defaults' => implode ( "\n", $timezones ) );
		$form ['default_app'] = array ('group' => '5_1','col' => '3','label' => '默认应用','widget' => 'select','defaults' => $defaultApps,'default' => '' );
		$form ['session_expire'] = array ('group' => '5_1','col' => '3','label' => '操作超时','default' => '900','rules' => array ('regexp(/^(0|[1-9][0-9]+)$/)' => '只能是数字.' ) );
		
		$form ['langs'] = array ('label' => '多语言支持','widget' => 'textarea','note' => '一行一个语言和模板设置,格式为(id;label[;template]). 如zh_cn;中文;default' );
		$form ['isOffline1'] = array ('group' => '1_6','col' => '6','label' => '系统维护','widget' => 'radio','default' => '0','defaults' => "0=否\n1=是" );
		
		$form ['isOffline'] = array ('group' => '1_6','col' => '6','label' => '接口维护','widget' => 'radio','default' => '0','defaults' => "0=否\n1=是" );
		$form ['allowIps1'] = array ('group' => '1_7','col' => '2','label' => '允许IP','note' => '一行一个','widget' => 'textarea','rows' => 8 );
		$form ['offlineMsg1'] = array ('group' => '1_7','col' => '4','label' => '系统维护提示信息','widget' => 'textarea','rows' => 8 );
		
		$form ['allowIps'] = array ('group' => '1_7','col' => '2','label' => '允许IP','note' => '一行一个','widget' => 'textarea','rows' => 8 );
		$form ['offlineMsg'] = array ('group' => '1_7','col' => '4','label' => '系统维护提示信息','widget' => 'textarea','rows' => 8 );
	}
}