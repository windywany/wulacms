...
$tables ['1.0.0'] [] = "CREATE TABLE IF NOT EXISTS `{prefix}bbs_forums` (
    ...
    `type` INT UNSIGNED NOT NULL COMMENT '帖子类型',
    ...
    `last_thread` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '最后帖子',
    `last_post` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '最后回复',
    `forum_expire` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '版块缓存时间',
    `thread_expire` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '帖子缓存时间',
	...
	`thread_url_pattern` varchar(1024) DEFAULT NULL COMMENT '帖子URL生成规则',
