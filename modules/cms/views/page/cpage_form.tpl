...
<section id="widget-grid">
    <div class="row">
        <article class="col-sm-12">
            <div class="jarviswidget" id="wid-cpage-form" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    <div class="widget-body widget-hide-overflow no-padding">
                        ...
                        <form name="CPageForm" data-widget="nuiValidate" action="{'cms/cpage/save'|app}" method="post"
                              id="page-form" class="smart-form" target="ajax">
                                    ...
                                    <section class="col col-2">
                                        ...
                                        <div class="inline-group">
                                            <label class="checkbox">
                                                <input type="checkbox" {if $is_tpl_page}checked="checked"{/if}
                                                       name="is_tpl_page"/>
                                                <i></i>模板页</label>
                                        </div>
                                    </section>
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            ...
                                            <b class="tooltip tooltip-top-left">
                                                {literal}
                                                    1. html 页面可以使用.shtml,.html,.html做为扩展名
                                                    <br/>
                                                    2. xml 页面请使用.xml做为扩展名
                                                    <br/>
                                                    3. js 脚本请使用.jsp做为扩展名
                                                    <br/>
                                                    4. json 数据请使用.json做为扩展名
                                                    <br/>
                                    ...
                                    <section class="col col-4">
                                        ...
                                        <label class="input" for="template_file">
                                            <input type="hidden" data-widget="nuiCombox" style="width:100%"
                                                   data-source="{'system/ajax/tpl'|app}" name="template_file"
                            ...
                            <footer>
                                {if !$id}
                                    <a style="display:none" class="btn btn-success" href="{'cms/cpage/add'|app}"
