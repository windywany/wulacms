...
class AdminPreferenceBaseForm {
	...
	public static function init($form) {
		...
		$form ['tags_count']     = array('group' => '1', 'col' => 3, 'label' => '替换内链个数', 'note' => '不填写时使用默认值10.', 'rules' => array('num' => '只能是整数。'));
		...
		$form ['allow_dash']     = array('group' => '1', 'col' => 2, 'label' => 'URL允许下划线', 'note' => '开启后将影响性能.', 'widget' => 'radio', 'default' => '0', 'defaults' => "1=启用\n0=不启用");
		...
		$form ['enable_copy']       = array('group' => '1_2', 'col' => '4', 'label' => '启用复制功能', 'widget' => 'radio', 'default' => '0', 'defaults' => "1=启用\n0=不启用");
		$form ['enable_full']       = array('group' => '1_2', 'col' => '4', 'label' => '启用全文索引功能', 'widget' => 'radio', 'default' => '0', 'defaults' => "1=启用\n0=不启用");
		$form ['disable_approving'] = array('group' => '2', 'col' => '4', 'label' => '启用审核功能', 'note' => '启用审核功能后只有状态是已发布的页面才能被访问.', 'widget' => 'radio', 'default' => '0', 'defaults' => "1=启用\n0=不启用");
		$status                     = array();
